...
* Create a model training pipeline (ok)
* Deploy the model in batch, web service or streaming (ok - batch)
* Monitor the performance of your model (ok)
* Follow the best practices (ok)
